...
class VolumeConverterBody extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<VolumeConverterBody> createState() => _VolumeConverterBodyState();
}

class _VolumeConverterBodyState extends ConsumerState<VolumeConverterBody> {
  // ===== Core State =====
  ...
  String _selectedUnit1 = 'Liters';
  String _selectedUnit2 = 'Milliliters';
  ...
  void _initializeConverter() {
    ...
    _converter.initialize(categoryId: 11); // Volume category
    _buildUnitMapping();
