...
import '../../shared/widgets/converter_keypad.dart';
import '../../shared/widgets/converter_display_panel.dart';
...
class TemperatureConverterBody extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TemperatureConverterBody> createState() => _TemperatureConverterBodyState();
}

class _TemperatureConverterBodyState extends ConsumerState<TemperatureConverterBody> {
  // ===== Core State =====
  ...
  String _selectedUnit1 = 'Celsius';
  String _selectedUnit2 = 'Fahrenheit';
  ...
  void _initializeConverter() {
    ...
    _converter.initialize(categoryId: 2); // Temperature category
    _buildUnitMapping();
    ...
    return SizedBox(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              l10n.temperatureConverterTitle,
              style: TextStyle(
